...
#Unified launcher to run ROSA
#Launch ROSA URDF, odom transform and frame and as arguments (default = true) LiDAR and RGBD Camera
...
def generate_launch_description():
  ...
  ld.add_action(Node(
    package='rosa_firmware',
    executable='rosa_driver',
    output='screen',
